...
public partial class CareBridgeScaffoldContext : DbContext
{
    ...
    public virtual DbSet<VwAnalytic> VwAnalytics { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ClaimId).HasName("PK__Claim__EF2E139BEB513BAD");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BED9D3C3471");
        ...
        {
            entity.HasKey(e => e.DiagnosisId).HasName("PK__Diagnosi__0C54CC7321EF42CA");
        ...
        {
            entity.HasKey(e => e.EncounterId).HasName("PK__Encounte__4278DD36B9CFE1B8");

            entity.ToTable("Encounter");

            entity.HasIndex(e => e.EncounterType, "NonClusteredIndex-20260604-154028");
        ...
        {
            entity.HasKey(e => e.InsuranceId).HasName("PK__Insuranc__74231A24C8B15294");
            ...
            entity.HasOne(d => d.Patient).WithMany(p => p.Insurances)
                .HasForeignKey(d => d.PatientId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Insurance__Patie__45F365D3");
        });

        modelBuilder.Entity<Patient>(entity =>
        {
            entity.HasKey(e => e.PatientId).HasName("PK__Patient__970EC36663BB2AB8");
            ...
            entity.HasIndex(e => e.Mrn, "UQ__Patient__C790FDB4E3C8AA49").IsUnique();
        ...
        {
            entity.HasKey(e => e.ProcedureId).HasName("PK__Procedur__54C2E52D2F6E7671");
        ...
        {
            entity.HasKey(e => e.ProviderId).HasName("PK__Provider__B54C687D34E8FA46");
            ...
            entity.HasOne(d => d.Department).WithMany(p => p.Providers)
                .HasForeignKey(d => d.DepartmentId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Provider__Depart__3E52440B");
        });

        modelBuilder.Entity<VwAnalytic>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("vw_Analytics");
